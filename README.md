...
```sh
git clone https://github.com/CallMeGuptaji/PublicLeech.git
cd PublicLeech
...
* `AUTH_CHANNEL`: Create a Super Group in Telegram, add `@guptaain_the_bot` to the group, and send /id in the chat, to get this value.
...
* add issues / feature requests, [here](https://github.com/CallMeGuptaji/PublicLeech/issues/new).
